...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'tasks' => App\GraphQL\Queries\TaskQuery::class,
                'reminders' => App\GraphQL\Queries\RemindersQuery::class,
                'dueReminders' => App\GraphQL\Queries\DueRemindersQuery::class,
            ],
            'mutation' => [
                'addReminder' => App\GraphQL\Mutations\Reminder\AddReminderMutation::class,
                'deleteReminder' => App\GraphQL\Mutations\Reminder\DeleteReminderMutation::class,
                ...
                'deleteTask' => App\GraphQL\Mutations\Task\DeleteTaskMutation::class,
                 'registerUser' => App\GraphQL\Mutations\Auth\RegisterUser::class,
                'loginUser' => App\GraphQL\Mutations\Auth\LoginUser::class,
                'RegisterSocial' => App\GraphQL\Mutations\Auth\RegisterSocialMutation::class,
                'updateUser' => App\GraphQL\Mutations\Auth\UpdateUserMutation::class,
                'resetPassword' => \App\GraphQL\Mutations\Auth\ResetPasswordMutation::class,
                'requestPasswordReset' => \App\GraphQL\Mutations\Auth\RequestPasswordResetMutation::class,
    
                'markTaskAsComplete' => \App\GraphQL\Mutations\Task\MarkTaskAsCompleteMutation::class,
            ...
            'types' => [
                ...
                'LogOutUser' => App\GraphQL\Types\LogOutUser::class,
                "User" => \App\GraphQL\Types\User::class,
                'OAuthToken' => \App\GraphQL\Types\OAuthTokenType::class,
                'Reminder' => \App\GraphQL\Types\ReminderType::class,
                'ResetPasswordResponse' => \App\GraphQL\Types\ResetPasswordResponseType::class,
            ],
